...
public class App {
    public static void main( String[] args )
    {
        ...
        kassa.login("albertusadrian","albertusadrian"); System.out.println("----------Skenario 4: Print Nota #1----------");
        kassa.tambahPesanan(produk1,1); kassa.tambahPesanan(produk2,2);
        kassa.printNota();
        System.out.println("----------Skenario 5: Print Nota #2----------");
        kassa.tambahPesanan(produk4,1);
        kassa.printNota(); System.out.println("----------Skenario 6: Login Berhasil (Username: antoniusfelix)----------");
        kassa.login("antoniusfelix","antoniusfelix"); System.out.println("----------Skenario 7: Print Nota #3----------");
        kassa.tambahPesanan(produk3,2); kassa.tambahPesanan(produk4,1);
        kassa.printNota(); System.out.println("----------Skenario 8: Informasi Pejualan Kasir----------");
